const AIAutomation = () => {
    const automationData = [
        { category: '간척 관리', rate: 99, daily: '1,280건', model: 'DeepSeek R1' },
        { category: '산업 유치', rate: 98, daily: '850건', model: 'DeepSeek R1' },
        { category: '환경 모니터링', rate: 99, daily: '3,200건', model: 'DeepSeek R1' },
        { category: '사업 관리', rate: 99, daily: '1,650건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 개발 관리 자동화</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {automationData.map((item, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-sky-900">{item.rate}%</td>
