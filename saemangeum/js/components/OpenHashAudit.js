    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">투명한 개발 관리 기록</p>
            </div>
                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y">
                        <tr className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 text-sm text-center text-gray-900">6,825,340</td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">오늘 생성 블록</td>
                            <td className="px-6 py-4 text-sm text-center font-semibold text-sky-900">88,000</td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">검증 성공률</td>
                            <td className="px-6 py-4 text-sm text-center font-semibold text-sky-900">100%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
