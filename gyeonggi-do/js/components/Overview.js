const Overview = () => (
    <div className="space-y-6 animate-slide-in">
        <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">🏙️ 경기도 OpenHash 시스템</h2>
            <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="border rounded-lg p-4">
                    <h3 className="font-bold text-blue-900 mb-3">기본 정보</h3>
                    <table className="w-full text-sm">
                        <tbody>
                            <tr className="border-b"><td className="py-2 font-medium">인구</td><td>약 1,370만명</td></tr>
                            <tr className="border-b"><td className="py-2 font-medium">특징</td><td>수도권, 최대 인구</td></tr>
