    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 2.87M건 트랜잭션 검증 완료 (1심 판결 보존)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-emerald-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-emerald-600">2.87M</div>
                <div className="text-xs text-gray-600 mt-1">검증된 1심 건수</div>
            </div>
            ...
            <div className="bg-lime-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-lime-600">0.17초</div>
