const AIAutomation = () => {
    const automationData = [
        { category: '유산 조사', rate: 99, daily: '320건', model: 'DeepSeek R1' },
        { category: '보존 처리', rate: 98, daily: '185건', model: 'DeepSeek R1' },
        { category: '관람 관리', rate: 99, daily: '42,000건', model: 'DeepSeek R1' },
        { category: '민원 처리', rate: 99, daily: '850건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 유산 관리 자동화</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {automationData.map((item, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-amber-800">{item.rate}%</td>
