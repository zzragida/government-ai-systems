const CHAApp = () => {
    ...
    return (
        <div className="min-h-screen">
            <header className="cha-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">국가유산청</h1>
                            <p className="text-amber-100 mt-1">Cultural Heritage Administration - AI 자동화 시스템</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-amber-100">AI 자동화율</div>
            ...
            <footer className="bg-gray-800 text-white mt-12">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            <h3 className="font-semibold mb-2">국가유산청</h3>
                            <p className="text-gray-400">Cultural Heritage Administration</p>
                            <p className="text-gray-400">문화체육관광부 소속 외청</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">연락처</h3>
                            <p className="text-gray-400">대표: 042-481-4650</p>
                            <p className="text-gray-400">민원: 1899-0001</p>
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                        <p>© 2025 국가유산청. All rights reserved. Powered by DeepSeek R1 + OpenHash</p>
                    </div>
                </div>
            </footer>
        </div>
