const AIAutomation = () => {
    const automationData = [
        { category: '기상 관측', rate: 99, daily: '166,560건', model: 'DeepSeek R1' },
        { category: '예보 작성', rate: 99, daily: '192건', model: 'DeepSeek R1' },
        { category: '레이더 분석', rate: 99, daily: '2,640건', model: 'DeepSeek R1' },
        { category: '데이터 검증', rate: 99, daily: '85,000건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 기상 업무 자동화</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {automationData.map((item, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-sky-700">{item.rate}%</td>
