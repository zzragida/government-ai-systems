const KMAApp = () => {
    ...
    return (
        <div className="min-h-screen">
            <header className="kma-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">기상청</h1>
                            <p className="text-sky-100 mt-1">Korea Meteorological Administration - AI 자동화 시스템</p>
                        </div>
            ...
            <footer className="bg-gray-800 text-white mt-12">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            <h3 className="font-semibold mb-2">기상청</h3>
                            <p className="text-gray-400">Korea Meteorological Administration</p>
                            <p className="text-gray-400">환경부 소속 중앙행정기관</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">연락처</h3>
                            <p className="text-gray-400">대표: 02-2181-0900</p>
                            <p className="text-gray-400">날씨예보: 131</p>
                            <p className="text-gray-400">위치: 서울 동작구</p>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                        <p>© 2025 기상청. All rights reserved. Powered by DeepSeek R1 + OpenHash</p>
                    </div>
                </div>
            </footer>
        </div>
