                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y">
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">재외동포정보시스템</td>
                            <td className="px-6 py-4 text-sm text-center">
                                <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">정상</span>
                            </td>
                            <td className="px-6 py-4 text-sm text-right text-gray-900">7,500,000건</td>
                            <td className="px-6 py-4 text-sm text-center text-gray-600">30초 전</td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">영사민원시스템</td>
                            <td className="px-6 py-4 text-sm text-center">
                                <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">정상</span>
                            </td>
                        ...
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">지원사업관리시스템</td>
                            <td className="px-6 py-4 text-sm text-center">
                                <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">정상</span>
                            </td>
                            <td className="px-6 py-4 text-sm text-right text-gray-900">425,000건</td>
                            <td className="px-6 py-4 text-sm text-center text-gray-600">1분 전</td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">네트워크관리시스템</td>
                            <td className="px-6 py-4 text-sm text-center">
                                <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">정상</span>
                            </td>
                            <td className="px-6 py-4 text-sm text-right text-gray-900">10,000건</td>
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="divide-y">
                            <tr className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 text-sm text-center text-green-700 font-semibold">99.9%</td>
                                <td className="px-6 py-4 text-sm text-gray-700">우수</td>
                            </tr>
                            <tr className="hover:bg-gray-50">
                                <td className="px-6 py-4 text-sm font-medium text-gray-900">데이터 정확성</td>
                                <td className="px-6 py-4 text-sm text-center text-green-700 font-semibold">99.8%</td>
                                <td className="px-6 py-4 text-sm text-gray-700">우수</td>
                            </tr>
                            <tr className="hover:bg-gray-50">
                                <td className="px-6 py-4 text-sm font-medium text-gray-900">데이터 일관성</td>
                                <td className="px-6 py-4 text-sm text-center text-green-700 font-semibold">99.7%</td>
                                <td className="px-6 py-4 text-sm text-gray-700">우수</td>
                            </tr>
                            <tr className="hover:bg-gray-50">
                                <td className="px-6 py-4 text-sm font-medium text-gray-900">평균 응답 시간</td>
                                <td className="px-6 py-4 text-sm text-center text-green-700 font-semibold">0.15초</td>
