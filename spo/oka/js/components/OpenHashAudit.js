const OpenHashAudit = () => {
    const recentBlocks = [
        { id: 'BLK5285450', timestamp: '14:23:45', type: '영사민원', transactions: 8500, hash: 'a7f9c3e8...', status: 'verified' },
        { id: 'BLK5285449', timestamp: '14:23:32', type: '지원사업', transactions: 2800, hash: 'f3b8e1d7...', status: 'verified' },
        { id: 'BLK5285448', timestamp: '14:23:18', type: '네트워크', transactions: 4200, hash: '8c2d9f4e...', status: 'verified' },
        { id: 'BLK5285447', timestamp: '14:23:05', type: '교육문화', transactions: 6500, hash: '5e9a2f8d...', status: 'verified' }
    ];
                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y">
                        <tr className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 text-sm text-center text-gray-900">5,285,450</td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">오늘 생성 블록</td>
                            <td className="px-6 py-4 text-sm text-center text-green-700 font-semibold">22,000</td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                        ...
                        <tr className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 text-sm text-center text-green-700 font-semibold">0.06초</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="divide-y">
                            ...
                            <tr className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 text-sm text-center text-green-700 font-semibold">5.2M건</td>
