const AIAutomation = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-cyan-600 to-cyan-700 text-white rounded-lg shadow-lg p-8">
                        ...
                        <div key={idx} className="border border-gray-200 rounded-lg p-4">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="text-right">
                                    <div className="text-2xl font-bold text-cyan-600">{item.automation}%</div>
