...
const ActivityLogs = () => {
    const mockLogs = [
        { timestamp: '2025-12-04 16:45:12', department: '건강보험정책국', action: '건강보험 진료비 심사', user: 'AI 자동분석', status: 'success', details: 'AI 심사: 금일 진료비 청구 285,000건. 자동 승인 282,150건, 추가심사 2,850건.' },
    ...
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-cyan-700 to-teal-700 text-white rounded-lg shadow-lg p-6">
                ...
                <p className="text-cyan-100 text-sm">모든 건강보험·복지급여는 실시간으로 기록됩니다</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-white rounded-lg shadow-md p-4">
                    <p className="text-sm text-gray-600">오늘 처리건수</p>
                    <p className="text-2xl font-bold text-cyan-700">325,180건</p>
                </div>
                <div className="bg-white rounded-lg shadow-md p-4">
                    <p className="text-sm text-gray-600">AI 자동처리</p>
                    <p className="text-2xl font-bold text-teal-700">321,603건</p>
                </div>
                <div className="bg-white rounded-lg shadow-md p-4">
                    <p className="text-sm text-gray-600">장관 결재</p>
                    <p className="text-2xl font-bold text-cyan-800">3,577건</p>
                </div>
                <div className="bg-white rounded-lg shadow-md p-4">
                    <p className="text-sm text-gray-600">긴급 대응</p>
                    <p className="text-2xl font-bold text-teal-800">0건</p>
                </div>
            </div>
