const Statistics = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-green-700 to-emerald-700 text-white rounded-lg shadow-lg p-8">
                        ...
                        <div key={idx} className="border border-gray-200 rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <div className="font-semibold text-green-600">{item.before}</div>
                                </div>
                                <div>
                                    <div className="text-gray-500 mb-1">AI 도입 후</div>
                                    <div className="font-semibold text-green-600">{item.after}</div>
                                </div>
                            </div>
                        </div>
                    ))}
