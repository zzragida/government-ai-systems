    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 3,289건 트랜잭션 검증 완료 (4,723 R&D 과제 추적)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-cyan-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-cyan-600">3,289</div>
                <div className="text-xs text-gray-600 mt-1">검증된 법안</div>
            </div>
            <div className="bg-green-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">7,142</div>
            ...
            <div className="bg-orange-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-orange-600">0.18초</div>
