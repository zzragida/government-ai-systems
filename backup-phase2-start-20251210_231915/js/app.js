const App = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <header className="jeju-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">제주특별자치도 AI 자동화 시스템</h1>
                            <p className="text-orange-100 mt-2">Jeju Special Self-Governing Province AI Automation</p>
                        </div>
                        <OpenHashBadge />
                    </div>
                </div>
