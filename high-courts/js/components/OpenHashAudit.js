        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 41,263건 트랜잭션 검증 완료 (항소심 판결 보존)</p>
                </div>
            </div>
        </div>
        ...
        <div className="border rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div className="bg-blue-50 p-3 rounded">
                    <div className="font-bold text-blue-900">양자내성 서명</div>
                    <div className="text-gray-600 text-xs mt-1">CRYSTALS-Dilithium (NIST PQC)</div>
                </div>
                <div className="bg-cyan-50 p-3 rounded">
                    <div className="font-bold text-cyan-900">해시 함수</div>
                ...
                <div className="bg-indigo-50 p-3 rounded">
                    <div className="font-bold text-indigo-900">머클 트리</div>
