            ...
            <header className="agency-header">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">국가인권위원회 AI 자동화 시스템</h1>
                            <p className="text-blue-100 text-sm">National Human Rights Commission - OpenHash & AI</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-blue-100">진정 처리 중</div>
                            <div className="text-2xl font-bold">3,245건</div>
                        </div>
                    </div>
                </div>
            </header>
