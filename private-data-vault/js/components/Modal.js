const Modal = ({ isOpen, onClose, title, children }) => {
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            className: 'relative bg-gray-800 rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto border border-gray-700 shadow-2xl',
            ...
            React.createElement('div', { className: 'sticky top-0 bg-gray-800 p-4 border-b border-gray-700 flex justify-between items-center' },
                React.createElement('h3', { className: 'text-xl font-bold text-blue-400' }, title),
