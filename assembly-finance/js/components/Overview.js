    ...
    return (
        <div className="space-y-6 animate-slide-in">
            <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">💰 기획재정위원회 OpenHash 시스템</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">위원장</td><td>임이자 (국민의힘)</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">위원 수</td><td>26명 (최대 규모)</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">소관</td><td>기획재정부, 한국은행</td></tr>
                                <tr><td className="py-2 font-medium">상세 정보</td><td><a href="https://finance.na.go.kr" target="_blank" className="text-blue-600 hover:underline">공식 홈페이지 →</a></td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">TPS</td><td className="text-green-600 font-bold">502.8 tx/s</td></tr>
                                ...
                                <tr><td className="py-2 font-medium">예산안 처리</td><td>3,847건/년</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-600 p-6 rounded-lg">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <div className="bg-white p-4 rounded shadow-sm">
                            ...
                            <h4 className="font-bold mb-2">예산안 실시간 검증</h4>
                            <p className="text-sm text-gray-600">AI 자동 분석<br/>3,847건/년</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">📊</div>
                            <h4 className="font-bold mb-2">세제 개편 투명성</h4>
                            <p className="text-sm text-gray-600">개정 이력 보존<br/>위변조 방지</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">🏦</div>
                            <h4 className="font-bold mb-2">통화정책 데이터</h4>
                            <p className="text-sm text-gray-600">한국은행 연동<br/>실시간 동기화</p>
                        </div>
                    </div>
                </div>
