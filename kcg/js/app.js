const KCGApp = () => {
    ...
    return (
        <div className="min-h-screen">
            <header className="kcg-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">해양경찰청</h1>
                            <p className="text-blue-100 mt-1">Korea Coast Guard - AI 자동화 시스템</p>
                        </div>
            ...
            <footer className="bg-gray-800 text-white mt-12">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            <h3 className="font-semibold mb-2">해양경찰청</h3>
                            <p className="text-gray-400">Korea Coast Guard (KCG)</p>
                            <p className="text-gray-400">해양수산부 소속 중앙행정기관</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">연락처</h3>
                            <p className="text-gray-400">해양사고 신고: 122</p>
                            <p className="text-gray-400">대표전화: 032-835-2114</p>
                            <p className="text-gray-400">위치: 인천 연수구</p>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                        <p>© 2025 해양경찰청. All rights reserved. Powered by DeepSeek R1 + OpenHash</p>
                    </div>
                </div>
            </footer>
        </div>
