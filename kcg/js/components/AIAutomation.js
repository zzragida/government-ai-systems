const AIAutomation = () => {
    const automationData = [
        { category: '해상 경비', rate: 99, daily: '8,500건', model: 'DeepSeek R1' },
        { category: '인명 구조', rate: 99, daily: '1,250건', model: 'DeepSeek R1' },
        { category: '범죄 수사', rate: 99, daily: '3,200건', model: 'DeepSeek R1' },
        { category: '안전 관리', rate: 99, daily: '5,800건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 해양 경비 자동화</p>
            </div>
