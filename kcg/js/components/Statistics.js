const Statistics = () => {
    const stats = [
        { label: '122 신고', value: '520,000건', change: '+3.8%' },
        { label: '인명 구조', value: '12,000명', change: '+5.2%' },
        { label: '해상 단속', value: '35,000건', change: '+8.5%' },
        { label: '오염 방제', value: '850건', change: '-12.3%' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">해양경찰청 주요 지표</p>
            </div>
