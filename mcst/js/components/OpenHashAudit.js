const OpenHashAudit = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-emerald-600 to-pink-700 text-white rounded-lg shadow-lg p-8">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {recentBlocks.map((block, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-mono text-pink-600">
