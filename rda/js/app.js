const RDAApp = () => {
    ...
    return (
        <div className="min-h-screen">
            <header className="rda-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">농촌진흥청</h1>
                            <p className="text-green-100 mt-1">Rural Development Administration - AI 자동화 시스템</p>
                        </div>
            ...
            <footer className="bg-gray-800 text-white mt-12">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            <h3 className="font-semibold mb-2">농촌진흥청</h3>
                            <p className="text-gray-400">Rural Development Administration</p>
                            <p className="text-gray-400">농림축산식품부 소속 외청</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">연락처</h3>
                            <p className="text-gray-400">대표: 063-238-1114</p>
                            <p className="text-gray-400">민원: 1544-8572</p>
                            <p className="text-gray-400">위치: 전북 전주시</p>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                        <p>© 2025 농촌진흥청. All rights reserved. Powered by DeepSeek R1 + OpenHash</p>
                    </div>
                </div>
            </footer>
        </div>
