const AIAutomation = () => {
    const automationData = [
        { category: '품종 개발', rate: 99, daily: '280건', model: 'DeepSeek R1' },
        { category: '재배 시험', rate: 99, daily: '520건', model: 'DeepSeek R1' },
        { category: '토양 분석', rate: 99, daily: '1,200건', model: 'DeepSeek R1' },
        { category: '기술 지도', rate: 99, daily: '3,500건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 농업연구 자동화</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {automationData.map((item, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-green-700">{item.rate}%</td>
