const Statistics = () => {
    const stats = [
        { label: '연간 범죄 발생', value: '195만건', change: '-8.5%' },
        { label: '범죄 검거율', value: '96.8%', change: '+12.6%p' },
        { label: '112 신고', value: '2,800만건', change: '+12.5%' },
        { label: '교통사고 사망자', value: '2,148명', change: '-26.3%' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">경찰청 주요 지표</p>
            </div>
