                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y">
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">112신고시스템</td>
                        ...
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">범죄수사시스템</td>
                            <td className="px-6 py-4 text-sm text-center">
                                <span className="px-2 py-1 bg-blue-100 text-blue-900 rounded text-xs font-medium">정상</span>
                            </td>
                            <td className="px-6 py-4 text-sm text-right text-gray-900">19,500,000건</td>
                        </tr>
                        <tr className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm font-medium text-gray-900">교통관리시스템</td>
                            <td className="px-6 py-4 text-sm text-center">
                                <span className="px-2 py-1 bg-blue-100 text-blue-900 rounded text-xs font-medium">정상</span>
                            </td>
                            <td className="px-6 py-4 text-sm text-right text-gray-900">9,120,000건</td>
                        </tr>
                    </tbody>
                </table>
            </div>
