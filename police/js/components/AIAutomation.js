const AIAutomation = () => {
    const automationData = [
        { category: '112 신고 접수', rate: 99, daily: '77,000건', model: 'DeepSeek R1' },
        { category: '범죄 수사', rate: 99, daily: '5,300건', model: 'DeepSeek R1' },
        { category: '교통 단속', rate: 99, daily: '25,000건', model: 'DeepSeek R1' },
        { category: '민원 처리', rate: 99, daily: '42,000건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 경찰 업무 자동화</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {automationData.map((item, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-blue-900">{item.rate}%</td>
