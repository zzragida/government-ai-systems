    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 12,384건 트랜잭션 검증 완료 (47.3M 의사록 보존)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-emerald-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-emerald-600">12,384</div>
                <div className="text-xs text-gray-600 mt-1">검증된 행정 건수</div>
            </div>
            <div className="bg-green-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">27,282</div>
            ...
            <div className="bg-purple-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-purple-600">0.16초</div>
