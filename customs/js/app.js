            ...
            <header className="customs-header">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">관세청 AI 자동화 시스템</h1>
                            <p className="text-teal-100 text-sm">
                                Korea Customs Service - OpenHash & AI Integration
                            </p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-teal-100">실시간 통관 처리</div>
                            <div className="text-2xl font-bold">3,456건/일</div>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <footer className="bg-gray-800 text-white mt-12 py-8">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-sm text-gray-400">
                        © 2025 관세청 AI 자동화 시스템 | OpenHash 기반 무결성 보장
                    </p>
                    <p className="text-xs text-gray-500 mt-2">
                        본 시스템은 국가데이터처와 연동하여 모든 통관 업무를 투명하게 기록합니다
                    </p>
                </div>
            </footer>
        </div>
...
ReactDOM.render(<CustomsApp />, document.getElementById('root'));
