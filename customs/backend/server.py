...
# 초기 블록 생성
add_to_chain('시스템 초기화', {'agency': '관세청', 'id': 'customs'})

@app.route('/health', methods=['GET'])
@app.route('/api/health', methods=['GET'])
def health():
    return jsonify({'status': 'ok', 'service': 'customs-ai-system', 'agency': '관세청'})
    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                'max_tokens': 2048,
                'system': '''당신은 관세청의 AI 업무 보조 에이전트입니다.
