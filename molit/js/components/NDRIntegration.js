                        ...
                        <div key={idx} className="border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow">
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold text-gray-600">{cat.records}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-600">데이터 크기</span>
                                    <span className="font-semibold text-gray-600">{cat.size}</span>
                                </div>
                                <div className="flex justify-between">
                                ...
                                <div className="flex justify-between pt-2 border-t border-gray-200">
                                    ...
                                    <span className="font-semibold text-slate-600">{cat.accessToday}회</span>
                                </div>
                            </div>
                        </div>
                    ))}
