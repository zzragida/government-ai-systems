    ...
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-slate-700 to-gray-800 text-white rounded-lg shadow-lg p-6">
                ...
                <p className="text-slate-100 text-sm">국토교통부는 2025년 10월 1일 확대 개편되었습니다</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white rounded-lg shadow-md p-4">
                    <p className="text-sm text-gray-600">본부 인력</p>
                    <p className="text-2xl font-bold text-slate-600">685명</p>
                </div>
                <div className="bg-white rounded-lg shadow-md p-4">
                    <p className="text-sm text-gray-600">산하기관</p>
                    <p className="text-2xl font-bold text-gray-600">15개</p>
                </div>
                <div className="bg-white rounded-lg shadow-md p-4">
                    <p className="text-sm text-gray-600">AI 자동화율</p>
                    <p className="text-2xl font-bold text-slate-700">98.3%</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                    <div className="p-4 bg-slate-50 rounded-lg border-l-4 border-slate-600">
                        <div className="font-semibold text-gray-900">국토교통부 장관</div>
