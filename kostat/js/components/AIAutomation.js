const AIAutomation = () => {
    const automationData = [
        { category: '인구 조사', rate: 99, daily: '12,500건', model: 'DeepSeek R1' },
        { category: '경제 통계', rate: 99, daily: '8,200건', model: 'DeepSeek R1' },
        { category: '물가 조사', rate: 99, daily: '15,000건', model: 'DeepSeek R1' },
        { category: '데이터 검증', rate: 99, daily: '25,000건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 통계 작성 자동화</p>
            </div>
