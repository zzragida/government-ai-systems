const KOSTATApp = () => {
    ...
    return (
        <div className="min-h-screen">
            <header className="kostat-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">통계청</h1>
                            <p className="text-blue-100 mt-1">Statistics Korea - AI 자동화 시스템</p>
                        </div>
            ...
            <footer className="bg-gray-800 text-white mt-12">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            <h3 className="font-semibold mb-2">통계청</h3>
                            <p className="text-gray-400">Statistics Korea (KOSTAT)</p>
                            <p className="text-gray-400">기획재정부 소속 중앙행정기관</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">연락처</h3>
                            <p className="text-gray-400">대표: 042-481-2114</p>
                            <p className="text-gray-400">민원: 02-2012-9114</p>
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                        <p>© 2025 통계청. All rights reserved. Powered by DeepSeek R1 + OpenHash</p>
                    </div>
                </div>
            </footer>
        </div>
