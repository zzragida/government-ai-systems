                        ...
                        <div key={idx} className="border border-gray-200 rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <div className="font-semibold text-teal-600">{item.after}</div>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="text-3xl font-bold text-teal-600 mb-1">39건</div>
                        <div className="text-sm text-gray-600">전체의 30.7%</div>
                    </div>
                    <div className="border border-gray-200 rounded-lg p-4">
                        <h4 className="font-semibold text-gray-900 mb-3">규제개혁</h4>
                        <div className="text-3xl font-bold text-teal-600 mb-1">28건</div>
