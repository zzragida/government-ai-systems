        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 3,542건 트랜잭션 검증 완료 (4,127건 중소기업 지원 추적)</p>
                </div>
            </div>
        </div>

        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-sky-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-sky-600">3,542</div>
                <div className="text-xs text-gray-600 mt-1">검증된 산업 안건</div>
            </div>
            <div className="bg-green-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">7,829</div>
        ...
        <div className="border rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div className="bg-sky-50 p-3 rounded">
                    <div className="font-bold text-sky-900">양자내성 서명</div>
