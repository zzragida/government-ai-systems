const AIAutomation = () => {
    const aiStats = {
        automationRate: 72.3,
        avgConfidence: 94.5,
        humanApprovalRate: 27.7,
        errorRate: 0.12
    };
    
    const aiTasks = [
        { task: '세무신고서 검토', automation: 85, confidence: 96, processed: 1245 },
        { task: '탈세 의심 거래 탐지', automation: 92, confidence: 98, processed: 234 },
        { task: '체납 가능성 예측', automation: 78, confidence: 91, processed: 456 },
        { task: '세무상담 자동 응답', automation: 88, confidence: 93, processed: 789 },
        { task: '신고서류 분류', automation: 95, confidence: 99, processed: 2134 }
    ];
        ...
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white rounded-lg shadow-lg p-8">
                ...
                <p className="text-lg text-purple-100">
                    DeepSeek R1 모델이 세무 업무를 자동으로 처리하며, 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-5 border border-blue-200">
                        ...
                        <ul className="space-y-2 text-sm text-gray-700">
                            <li>• 세무 전문 학습 데이터 500만 건</li>
                            <li>• 실시간 추론 속도 0.8초</li>
                            <li>• 다국어 지원 (한글 최적화)</li>
                            <li>• 지속적 학습 및 업데이트</li>
                        </ul>
                    </div>
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-5 border border-purple-200">
                        ...
                        <ul className="space-y-2 text-sm text-gray-700">
                            <li>• 신뢰도 90% 이상: 자동 처리</li>
                            <li>• 신뢰도 70-90%: 인간 검토</li>
                            <li>• 신뢰도 70% 미만: 인간 처리</li>
