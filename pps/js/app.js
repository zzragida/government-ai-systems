        ...
        <div className="min-h-screen bg-gray-50">
            <header className="agency-header">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">조달청 AI 자동화 시스템</h1>
                            <p className="text-indigo-100 text-sm">Public Procurement Service - OpenHash & AI</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-indigo-100">실시간 입찰 처리</div>
                            <div className="text-2xl font-bold">2,890건/일</div>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <footer className="bg-gray-800 text-white mt-12 py-8">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-sm text-gray-400">© 2025 조달청 AI 자동화 시스템 | OpenHash 기반</p>
                </div>
            </footer>
        </div>
    );
