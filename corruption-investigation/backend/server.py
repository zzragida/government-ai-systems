...
# 초기 블록 생성
add_to_chain('시스템 초기화', {'agency': '공수처', 'id': 'corruption-investigation'})

@app.route('/health', methods=['GET'])
@app.route('/api/health', methods=['GET'])
def health():
    return jsonify({'status': 'ok', 'service': 'corruption-investigation-ai-system', 'agency': '공수처'})
    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                'max_tokens': 2048,
                'system': '''당신은 공수처의 AI 업무 보조 에이전트입니다.
