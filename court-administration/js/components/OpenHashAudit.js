    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 18.4M건 트랜잭션 검증 완료 (사법행정 데이터)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-teal-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-teal-600">18.4M</div>
                <div className="text-xs text-gray-600 mt-1">검증된 데이터 건수</div>
            </div>
            <div className="bg-green-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">21.7M</div>
            ...
            <div className="bg-emerald-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-emerald-600">0.14초</div>
        ...
        <div className="border rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div className="bg-teal-50 p-3 rounded">
                    <div className="font-bold text-teal-900">양자내성 서명</div>
                ...
                <div className="bg-emerald-50 p-3 rounded">
                    <div className="font-bold text-emerald-900">머클 트리</div>
