    ...
    return (
        <div className="space-y-6 animate-slide-in">
            <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">💵 국회예산정책처 OpenHash 시스템</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">처장</td><td>조의섭</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">직원 수</td><td>147명</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">역할</td><td>예산·결산 분석</td></tr>
                                <tr><td className="py-2 font-medium">상세 정보</td><td><a href="https://www.nabo.go.kr" target="_blank" className="text-amber-600 hover:underline">공식 홈페이지 →</a></td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">TPS</td><td className="text-green-600 font-bold">527.9 tx/s</td></tr>
                                ...
                                <tr><td className="py-2 font-medium">예산 분석</td><td>677조원</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-l-4 border-amber-600 p-6 rounded-lg">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <div className="bg-white p-4 rounded shadow-sm">
                            ...
                            <h4 className="font-bold mb-2">예산안 분석</h4>
                            <p className="text-sm text-gray-600">677조원 국가예산<br/>OpenHash 검증</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">🔍</div>
                            <h4 className="font-bold mb-2">결산 검토</h4>
                            <p className="text-sm text-gray-600">집행 적정성<br/>AI 자동 분석</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">💡</div>
                            <h4 className="font-bold mb-2">재정 정책 연구</h4>
                            <p className="text-sm text-gray-600">중장기 전망<br/>시뮬레이션</p>
                        </div>
                    </div>
                </div>
