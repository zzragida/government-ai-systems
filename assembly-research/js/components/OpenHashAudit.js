    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 3,847건 트랜잭션 검증 완료 (입법 조사 보고서)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-orange-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-orange-600">3,847</div>
                <div className="text-xs text-gray-600 mt-1">검증된 조사 건수</div>
            </div>
            <div className="bg-green-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">8,473</div>
            ...
            <div className="bg-amber-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-amber-600">0.19초</div>
        ...
        <div className="border rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-3 text-sm">
                ...
                <div className="bg-red-50 p-3 rounded">
                    <div className="font-bold text-red-900">해시 함수</div>
                ...
                <div className="bg-amber-50 p-3 rounded">
                    <div className="font-bold text-amber-900">머클 트리</div>
