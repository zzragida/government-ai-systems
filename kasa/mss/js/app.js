            ...
            <header className="mss-header">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">중소벤처기업부 AI 자동화 시스템</h1>
                            <p className="text-gray-300 text-sm">
                                Ministry of SMEs and Startups - OpenHash & AI Integration
                            </p>
                        </div>
            ...
            <footer className="bg-gray-800 text-white mt-12 py-8">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-sm text-gray-400">
                        © 2025 중소벤처기업부 AI 자동화 시스템 | OpenHash 기반 무결성 보장
                    </p>
                    <p className="text-xs text-gray-500 mt-2">
                        본 시스템은 국가데이터처와 연동하여 모든 중소벤처 지원 정보를 투명하게 기록합니다
                    </p>
                </div>
            </footer>
        </div>
...
ReactDOM.render(<MSSApp />, document.getElementById('root'));
