        ...
        <div className="min-h-screen bg-gray-50">
            <header className="agency-header">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">기획재정부 AI 자동화 시스템</h1>
                            <p className="text-indigo-100 text-sm">Ministry of Economy and Finance - OpenHash & AI</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-indigo-100">실시간 재정 집행</div>
                            <div className="text-2xl font-bold">5678건/일</div>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <footer className="bg-gray-800 text-white mt-12 py-8">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-sm text-gray-400">© 2025 기획재정부 AI 자동화 시스템</p>
                </div>
            </footer>
        </div>
    );
