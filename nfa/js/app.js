const NFAApp = () => {
    ...
    return (
        <div className="min-h-screen">
            <header className="nfa-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">소방청</h1>
                            <p className="text-orange-100 mt-1">National Fire Agency - AI 자동화 시스템</p>
                        </div>
            ...
            <footer className="bg-gray-800 text-white mt-12">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            <h3 className="font-semibold mb-2">소방청</h3>
                            <p className="text-gray-400">National Fire Agency</p>
                            <p className="text-gray-400">행정안전부 소속 외청</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">연락처</h3>
                            <p className="text-gray-400">긴급신고: 119</p>
                            <p className="text-gray-400">대표: 044-205-7114</p>
                            <p className="text-gray-400">민원: 1661-1119</p>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                        <p>© 2025 소방청. All rights reserved. Powered by DeepSeek R1 + OpenHash</p>
                    </div>
                </div>
            </footer>
        </div>
