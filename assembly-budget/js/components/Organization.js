        ...
        <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-600 p-4 mb-6">
                <p className="text-sm text-gray-700">
                    ...
                    <a href="https://budget.na.go.kr" target="_blank" className="text-amber-600 hover:underline ml-1">예산결산특별위원회 공식 홈페이지</a>에서 확인하세요.
                </p>
            </div>

            <div className="space-y-6">
                <div className="border rounded-lg p-6">
                    <h3 className="font-bold text-lg mb-4">📊 OpenHash 노드 구성 (51개)</h3>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-gray-50 p-4 rounded">
                            <h4 className="font-bold mb-2 text-amber-900">위원 노드 (50개)</h4>
                ...
                <div className="border rounded-lg p-6">
                    <h3 className="font-bold text-lg mb-4">🔄 예산안 데이터 흐름</h3>
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 bg-blue-50 p-3 rounded">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-xs text-gray-600">재정 건전성, 중복 사업, 효율성 자동 평가</div>
                            </div>
                            <span className="text-green-600 font-mono text-xs">3.8초</span>
                        </div>
                        <div className="flex items-center gap-3 bg-purple-50 p-3 rounded">
                            <span className="text-2xl">💰</span>
                            <div className="flex-1">
                                <div className="font-bold text-sm">위원 심사 의결</div>
                                <div className="text-xs text-gray-600">AI 권고 수용률 78.9% → 예산 확정</div>
                            </div>
                        ...
                        <div className="flex items-center gap-3 bg-green-50 p-3 rounded">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-xs text-gray-600">51개 노드 동시 저장 → 국민 열람</div>
                            </div>
