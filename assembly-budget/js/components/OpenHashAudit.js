    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 8,927건 트랜잭션 검증 완료 (677조원 예산 추적)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-amber-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-amber-600">8,927</div>
                <div className="text-xs text-gray-600 mt-1">검증된 예산 안건</div>
            </div>
            ...
            <div className="bg-purple-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-purple-600">0.17초</div>
