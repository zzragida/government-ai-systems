    ...
    return (
        <div className="space-y-6 animate-slide-in">
            <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">🔒 정보위원회 OpenHash 시스템</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">위원장</td><td>박선원 (더불어민주당)</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">위원 수</td><td>12명</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">소관</td><td>국정원, 국방정보본부</td></tr>
                                <tr><td className="py-2 font-medium">상세 정보</td><td><a href="https://intelligence.na.go.kr" target="_blank" className="text-indigo-600 hover:underline">공식 홈페이지 →</a></td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">TPS</td><td className="text-green-600 font-bold">487.6 tx/s</td></tr>
                                ...
                                <tr><td className="py-2 font-medium">기밀 등급</td><td>최고 보안</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border-l-4 border-indigo-600 p-6 rounded-lg">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <div className="bg-white p-4 rounded shadow-sm">
                            ...
                            <h4 className="font-bold mb-2">정보 활동 감독</h4>
                            <p className="text-sm text-gray-600">국정원 활동<br/>OpenHash 기록</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">🔐</div>
                            <h4 className="font-bold mb-2">예산 투명성</h4>
                            <p className="text-sm text-gray-600">기밀비 집행<br/>위변조 방지</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">🎯</div>
                            <h4 className="font-bold mb-2">AI 위협 탐지</h4>
                            <p className="text-sm text-gray-600">사이버 공격<br/>실시간 차단</p>
                        </div>
                    </div>
                </div>
