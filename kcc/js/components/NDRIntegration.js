    ...
    const dataFlowSteps = [
        {
            step: 1,
            title: '데이터 요청',
            description: '방미통위 담당자가 업무 수행을 위해 NDR에 데이터 인출 요청',
            icon: '📝',
            color: 'blue'
        },
        {
        ...
        },
        {
            step: 3,
            title: 'NDR 데이터 인출',
            description: '암호화된 데이터를 NDR에서 방미통위 시스템으로 전송',
            icon: '📥',
            color: 'green'
        },
        {
            step: 4,
            title: 'AI 처리/분석',
            description: 'DeepSeek R1 AI가 방송·통신 데이터를 분석하고 자동 처리',
            icon: '🤖',
            color: 'orange'
        },
        {
            step: 5,
            title: '인간 검토/승인',
            description: '중요 의사결정은 담당자 또는 국장이 최종 승인',
            icon: '✅',
            color: 'blue'
        },
        {
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white rounded-lg shadow-lg p-8">
                ...
                <p className="text-lg text-green-100">
                    모든 방송·미디어·통신 데이터는 국가데이터처(NDR)에 중앙 집중식으로 관리되며, 
                    방미통위는 업무 수행에 필요한 데이터만 인출하여 처리합니다.
                </p>
            </div>
                        ...
                        <div key={idx} className="border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold text-green-600">{cat.size}</span>
                                </div>
                                <div className="flex justify-between">
