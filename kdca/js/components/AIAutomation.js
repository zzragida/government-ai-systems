const AIAutomation = () => {
    const automationData = [
        { category: '역학 조사', rate: 99, daily: '3,500건', model: 'DeepSeek R1' },
        { category: '감염병 신고', rate: 99, daily: '4,200건', model: 'DeepSeek R1' },
        { category: '예방접종 관리', rate: 99, daily: '78,000건', model: 'DeepSeek R1' },
        { category: '검역 검사', rate: 99, daily: '12,500건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 질병 관리 자동화</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {automationData.map((item, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-cyan-800">{item.rate}%</td>
