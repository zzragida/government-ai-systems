const Statistics = () => {
    const stats = [
        { label: '법정 감염병', value: '80종', change: '+5종' },
        { label: '감염병 신고', value: '150만건', change: '+8.2%' },
        { label: '예방접종', value: '2,800만건', change: '+12.5%' },
        { label: '검역 검사', value: '450만건', change: '+22.8%' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">질병관리청 주요 지표</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {stats.map((stat, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-cyan-800">{stat.change}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
