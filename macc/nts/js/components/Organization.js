    ...
    const organization = {
        headquarters: {
            ...
            departments: [
                ...
                { id: 'investigation', name: '조사국', staff: 450, mainTasks: ['세무조사', '탈세 단속', '고액체납자 관리'] },
                { id: 'collection', name: '징세국', staff: 380, mainTasks: ['세금 징수', '체납 처분', '납부 독려'] },
                { id: 'corporate-tax', name: '법인세국', staff: 290, mainTasks: ['법인세 신고 관리', '법인세 정책', '기업 세무상담'] },
        ...
        regional: [
            { name: '서울지방국세청', location: '서울 중구', staff: 2800, districts: 30 },
            { name: '중부지방국세청', location: '대전 서구', staff: 1950, districts: 22 },
            { name: '부산지방국세청', location: '부산 동구', staff: 1680, districts: 19 },
            { name: '대구지방국세청', location: '대구 북구', staff: 1420, districts: 16 },
            { name: '광주지방국세청', location: '광주 서구', staff: 1280, districts: 15 },
            { name: '인천지방국세청', location: '인천 남동구', staff: 1150, districts: 13 },
            { name: '대전지방국세청', location: '대전 서구', staff: 980, districts: 12 }
        ]
    };
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">국세청 조직 구조</h2>
            ...
            {/* 지방국세청 */}
            <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">지방국세청</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
