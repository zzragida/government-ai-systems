const AIAutomation = () => {
    const automationData = [
        { category: '건설 공정', rate: 99, daily: '1,850건', model: 'DeepSeek R1' },
        { category: '예산 집행', rate: 99, daily: '2,200건', model: 'DeepSeek R1' },
        { category: '주택 공급', rate: 98, daily: '850건', model: 'DeepSeek R1' },
        { category: '이전 지원', rate: 99, daily: '420건', model: 'DeepSeek R1' }
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="border-b pb-4">
                ...
                <p className="text-sm text-gray-600 mt-1">DeepSeek R1 기반 건설 관리 자동화</p>
            </div>
                        ...
                        <tbody className="divide-y">
                            {automationData.map((item, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center font-semibold text-orange-700">{item.rate}%</td>
