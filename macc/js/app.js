const MACCApp = () => {
    ...
    return (
        <div className="min-h-screen">
            <header className="macc-header text-white shadow-lg">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">행정중심복합도시건설청</h1>
                            <p className="text-orange-100 mt-1">Multifunctional Administrative City Construction Agency - AI 자동화 시스템</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-orange-100">AI 자동화율</div>
            ...
            <footer className="bg-gray-800 text-white mt-12">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            <h3 className="font-semibold mb-2">행정중심복합도시건설청</h3>
                            <p className="text-gray-400">Multifunctional Administrative City Construction Agency</p>
                            <p className="text-gray-400">국무총리 소속 중앙행정기관</p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-2">연락처</h3>
                            <p className="text-gray-400">대표: 044-850-1114</p>
                            <p className="text-gray-400">민원: 044-850-1700</p>
                            <p className="text-gray-400">위치: 세종특별자치시</p>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                        <p>© 2025 행정중심복합도시건설청. All rights reserved. Powered by DeepSeek R1 + OpenHash</p>
                    </div>
                </div>
            </footer>
        </div>
