    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 1,951건 심판 트랜잭션 검증 완료</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-purple-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-purple-600">1,951</div>
                <div className="text-xs text-gray-600 mt-1">연간 심판 건수</div>
            </div>
            ...
            <div className="bg-fuchsia-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-fuchsia-600">13</div>
                <div className="text-xs text-gray-600 mt-1">활성 노드</div>
            </div>
            <div className="bg-pink-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-pink-600">0.11초</div>
        ...
        <div className="border rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-3 text-sm">
                ...
                <div className="bg-fuchsia-50 p-3 rounded">
                    <div className="font-bold text-fuchsia-900">해시 함수</div>
                    <div className="text-gray-600 text-xs mt-1">SHA-3 (Keccak)</div>
                </div>
                <div className="bg-pink-50 p-3 rounded">
                    <div className="font-bold text-pink-900">대칭키 암호</div>
