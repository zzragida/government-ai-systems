            ...
            <header className="agency-header">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">국가교육위원회 AI 자동화 시스템</h1>
                            <p className="text-green-100 text-sm">National Education Commission - OpenHash & AI</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-green-100">정책 심의 중</div>
