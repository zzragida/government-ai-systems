    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 4,738건 트랜잭션 검증 완료 (특허소송 판결 보존)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-orange-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-orange-600">4,738</div>
                <div className="text-xs text-gray-600 mt-1">검증된 사건 건수</div>
            </div>
            <div className="bg-green-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">5,847</div>
            ...
            <div className="bg-yellow-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-yellow-600">0.18초</div>
        ...
        <div className="border rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div className="bg-orange-50 p-3 rounded">
                    <div className="font-bold text-orange-900">양자내성 서명</div>
                    <div className="text-gray-600 text-xs mt-1">CRYSTALS-Dilithium (NIST PQC)</div>
                </div>
                <div className="bg-amber-50 p-3 rounded">
                    <div className="font-bold text-amber-900">해시 함수</div>
