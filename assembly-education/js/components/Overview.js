    ...
    return (
        <div className="space-y-6 animate-slide-in">
            <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">📚 교육위원회 OpenHash 시스템</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">위원장</td><td>조명희 (국민의힘)</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">위원 수</td><td>18명</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">소관</td><td>교육부</td></tr>
                                <tr><td className="py-2 font-medium">상세 정보</td><td><a href="https://educ.na.go.kr" target="_blank" className="text-purple-600 hover:underline">공식 홈페이지 →</a></td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b"><td className="py-2 font-medium">TPS</td><td className="text-green-600 font-bold">478.9 tx/s</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">블록 생성</td><td>0.20초</td></tr>
                                <tr className="border-b"><td className="py-2 font-medium">검증 정확도</td><td>100%</td></tr>
                                <tr><td className="py-2 font-medium">학생 데이터</td><td>9.2M건 보호</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-l-4 border-purple-600 p-6 rounded-lg">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <div className="bg-white p-4 rounded shadow-sm">
                            ...
                            <h4 className="font-bold mb-2">학생 데이터 보호</h4>
                            <p className="text-sm text-gray-600">9.2M 학생 정보<br/>개인정보금고 연동</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">📖</div>
                            <h4 className="font-bold mb-2">교육과정 투명성</h4>
                            <p className="text-sm text-gray-600">교과서 검정<br/>위변조 방지</p>
                        </div>
                        <div className="bg-white p-4 rounded shadow-sm">
                            <div className="text-2xl mb-2">🏫</div>
                            <h4 className="font-bold mb-2">학교 예산 추적</h4>
                            <p className="text-sm text-gray-600">실시간 감사<br/>불법 지출 차단</p>
                        </div>
                    </div>
                </div>
