            ...
            <header className="agency-header">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">고위공직자범죄수사처 AI 자동화 시스템</h1>
                            <p className="text-red-100 text-sm">Corruption Investigation Office - OpenHash & AI</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-red-100">진행 중 사건</div>
