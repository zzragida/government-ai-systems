    ...
    <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-4 mb-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">전체 2,647건 트랜잭션 검증 완료 (4,892건 저작권 보호)</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
            <div className="bg-fuchsia-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-fuchsia-600">2,647</div>
                <div className="text-xs text-gray-600 mt-1">검증된 문화 안건</div>
            </div>
            <div className="bg-green-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">5,829</div>
            ...
            <div className="bg-purple-50 border rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-purple-600">0.20초</div>
        ...
        <div className="border rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div className="bg-fuchsia-50 p-3 rounded">
                    <div className="font-bold text-fuchsia-900">양자내성 서명</div>
